    ...
    var stat2Chart = Highcharts.chart('stat2', {
        ...
        series: [{
            ...
            color: {
                ...
                stops: [[0, colorN], [1, Highcharts.color(colorN).brighten(-0.3).get('rgb')] // darken
                ]
            },
            dataLabels: {
                enabled: true,
            ...
            color: {
                ...
                stops: [[0, colorG], [1, Highcharts.color(colorG).brighten(-0.3).get('rgb')] // darken
                ]
            },
            dataLabels: {
                enabled: true,
            ...
            color: {
                ...
                stops: [[0, colorD], [1, Highcharts.color(colorD).brighten(-0.3).get('rgb')] // darken
                ]
            },
            dataLabels: {
                enabled: true,
